...
public abstract class Goal
{
    ...
    {
        Console.Write("Enter the category for your goal (e.g., health, work, learning): ");
    ...
    public Goal()
    {
        ...
        this._category = SetCategory();
    }

    public Goal(string name, string description, double points, int timesFinished, string category)
    {
        this._name = name;
